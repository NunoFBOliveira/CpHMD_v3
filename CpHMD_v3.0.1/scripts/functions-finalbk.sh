...
##     cp -f ${runname}.sites ${runname}-all.sites
    ...
    echo "Solute" | "$GroDIR" trjconv -f $PDBin -s $PDBin\
    ...
    ##### END of auxiliary file function in new version ################
    ...
    #
    #### Parte para pegar o .pbp certo usando o 
